...
export const CHAOS_QUOTES = [
  ...
  "ركز ياض!",
  "روح ذاكر يا فاشل",
  "السرير بينادي عليك صح؟ قوم ذاكر!",
  "هتندم يوم النتيجة يا متخاذل",
  "الدولي باصص عليك دلوقتي 👀",
  "الامتياز محتاج تعب مش نوم",
  "شاب شاطر كدا وبتضيع وقتك؟",
  "القهوة مش هتحل الامتحان مكانك",
  "سيب الموبايل وقوم ذاكر",
  "الستريك بتاعك هيضيع لو نمت",
  "فين الحماس بتاع أول الأسبوع؟",
  "مستني إيه؟ معجزة؟",
  "مفيش نجاح بالبركة، قوم اشتغل",
  "كل ثانية بتعدي هي خسارة",
  "الدحيحة مبيعملوش كدا",
  "أنت بطل بس محتاج تركز",
  "المرقعة أخرتها وحشة",
  "الامتحان قرب يسطا",
  "متخليش الكسل يكسبك",
  "أنت قدها بس لو بطلت تتفرج على الميمز",
  "عمرك شفت متفوق نايم الساعة ٢ الضهر؟",
  "بكرة هتقول يا ريتني بدأت بدري",
  "قوم فز، بلاش كسل!",
  "الشيطان شاطر بس أنت أشطر",
  "ذاكر عشان تفرح أهلك (أو عشان متسقطش)"
];
